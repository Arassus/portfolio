...
namespace ClickerTajper_00_Console_P
{
    class Projekt
    {
        ...
        public int MineloDni, Zasoby_Opinia;
        ...
        /// <summary>          
        /// Konstrukor wprowadzający domyślne rozmiary kontrolek.
        /// </summary>
        public Projekt()                                                           
        {                                                                         
            DomyslneProjekty(new Point(0, 0), 200, 400, View.Details);//"0;0;200;400;"new Point(0, 0), 200, 400, View.Details);          
            DomyslnyWidok_Button(new Point(400, 150), 50, 50);                  
            DomyslnyZaplac_Button(new Point(450, 150), 50, 50);                
                                                                              
            SchowajKontrolki();                                             
        }

        /// <summary>
        /// Kontrolka Projekty przyjmuje Właściwości na podstawie Parametrów. 
        /// </summary>
        /// <param name="Lokalizacja"></param>
        /// <param name="Wysokosc"></param>
        /// <param name="Szerokosc"></param>
        /// <param name="Widok"></param>
        private void DomyslneProjekty(Point Lokalizacja,int Wysokosc, int Szerokosc, View Widok)//string Parametry)               
        {                                                                                                      
        ...
        {                                                                                            //
            ...
            {                                                                                    //
                Zwracana += int.Parse(L.SelectedItems[i].SubItems[ID].Text);                    //
                                                                                              ...
                                                                                              //
            return Zwracana;                                                                 //
        }// Wyciaga sume intowych subitemow[ID] z itemow konkretnego listview
        private void OdswiezZaplac_Button()                                                               //
        {                                                                                                //
            int Suma = SumaWyrazowZListView(ref Projekty, 4);                                           //
            Console.WriteLine("Suma kosztow :" + Suma);                                                //
            if (Suma > Zasoby_Opinia)                                                                 //
            {                                                                                        //
                MoznaKupic = false;                                                                 //
        ...
        {                                                                       ///////////////////////////////////////
            ...
            Console.WriteLine("Wylosowano Nazwe : " + Zwracany);                ////////////////////////////////////
            return Zwracany;                                                    ///////////////////////////////////
        }                                                                       //////////////////////////////////
        private string Losuj_Deadline(char ZnakPomiedzy)                        ////////////////////////////////
        {                                                                       ///////////////////////////////
            Random r = new Random();                                            //////////////////////////////
            string Zwracany = r.Next(1, 365).ToString() + ZnakPomiedzy;         /////////////////////////////
            Console.WriteLine("Wylosowano Deadline : " + Zwracany);             ////////////////////////////
            return Zwracany;                                                    ///////////////////////////
        }                                                                       //////////////////////////
